...
...
```
    Я не понимаю, почему не работает. Я могу подключится по ssh, польователь находится в группе sudo, но при попытке установить что-нибудь - запрашивается пароль рута.
